...
\usepackage{graphicx}
\usepackage{amsmath} % amsmath is loaded by revtex4-2, but explicit loading is fine.
...
\affiliation{
 Your Department, Your University, City, Country
}

\author{Another Author}
\affiliation{
 Their Department, Their University, City, Country
}
...
% \begin{figure}
%     \centering
%     \includegraphics[width=\columnwidth]{band_structure.png}
%     \caption{Calculated electronic band structure of the 1:1 AlN/TiN superlattice (a) without and (b) with spin-orbit coupling. The inset in (b) shows a magnified view near the Gamma point, highlighting the Rashba splitting along Gamma-K and the larger Dresselhaus-like splitting along Gamma-A.}
%     \label{fig:bands}
% \end{figure}
...
\bibitem{shalaev_plasmonics_2007}
...
\bibitem{verma_superconducting_2021}
...
\bibitem{lita_high-quality_2017}
...
\bibitem{giannozzi_quantum_2009}
